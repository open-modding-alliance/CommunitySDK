# ScriptBinding
In the `sdk\debugger` subfolder of your FS installation you will find a file named `scriptBinding.xml`. This file contains documentation for the built-in/native Giants Engine functions that is not part of the API reference on the GDN website.
